        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_ProgramTypes_ProgramTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeachingCoursesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessorCourses", x => new { x.ProfessorsId, x.TeachingCoursesId });
                    table.ForeignKey(
                        name: "FK_ProfessorCourses_Courses_TeachingCoursesId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Svučilišni prijediplomski studij" },
                    { 2, "Stručni prijediplomski studij" },
                    { 3, "Diplomski sveučilišni studij" },
                    { 4, "Diplomski stručni studij" },
                    { 5, "Doktorski studij" },
                    { 6, "Razlikovni studij" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ProfessorCourses_TeachingCoursesId",
